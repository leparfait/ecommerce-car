...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_39ce525bc00e8339d62472dc96a0cdb6204fb77930afd5b423e00fc89cc9ba2b');
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Ecommerce\EcommerceBundle\Service\getFacture A Ecommerce\EcommerceBundle\Service\getFacture instance.
     */
    protected function getSetnewfactureService()
    {
        return $this->services['setnewfacture'] = new \Ecommerce\EcommerceBundle\Service\getFacture($this);
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Ecommerce\EcommerceBundle\Service\getReference A Ecommerce\EcommerceBundle\Service\getReference instance.
     */
    protected function getSetnewreferenceService()
    {
        return $this->services['setnewreference'] = new \Ecommerce\EcommerceBundle\Service\getReference($this->get('security.context'), $this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('parfaitonana4@gmail.com');
        $a->setPassword(78637863);
        $a->setAuthMode(NULL);
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Ecommerce\\EcommerceBundle/Resources/translations\\messages.en.yml'), 'en', 'messages');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Ecommerce\\EcommerceBundle/Resources/translations\\messages.fr.yml'), 'fr', 'messages');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('telephone', '+237 690 59 84 62');
        $instance->addGlobal('fax', '+237 699 79 23 37');
        $instance->addGlobal('adresse', 'Douala-Cameroun ; Bonapriso rue njo njo');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_user' => 'parfaitonana4@gmail.com',
            'mailer_password' => 78637863,
            'locale' => 'fr',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'parfaitonana4@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 78637863,
