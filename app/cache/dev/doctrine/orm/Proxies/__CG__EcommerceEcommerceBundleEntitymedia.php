...
class media extends \Ecommerce\EcommerceBundle\Entity\media implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\media' . "\0" . 'id', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\media' . "\0" . 'updatedAt', 'name', 'path', 'file'];
        }

        return ['__isInitialized__', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\media' . "\0" . 'id', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\media' . "\0" . 'updatedAt', 'file'];
    }
